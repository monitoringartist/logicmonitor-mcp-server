...
describe('LogicMonitorHandlers', () => {
  ...
  beforeEach(() => {
    ...
    // Fully-typed mock client derived from the real client surface (see
    // fixtures-helpers.ts). Read defaults are disabled so each test sets its own
    // return values, preserving the original behavior.
