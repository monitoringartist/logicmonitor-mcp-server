...
export const TOOL_SCOPE_REQUIREMENTS: Record<string, string[]> = {
  ...
  'list_cost_recommendations': ['mcp:tools', 'lm:read'],
  'get_cost_recommendation': ['mcp:tools', 'lm:read'],
  'list_cost_recommendation_categories': ['mcp:tools', 'lm:read'],
  ...
  'list_resource_alert_confs': ['mcp:tools', 'lm:read'],
  'list_instance_alert_confs': ['mcp:tools', 'lm:read'],
  'get_instance_alert_conf': ['mcp:tools', 'lm:read'],
  'update_instance_alert_conf': ['mcp:tools', 'lm:write'],
  ...
  'get_resource_group_datasource_alert_conf': ['mcp:tools', 'lm:read'],
  'update_resource_group_datasource_alert_conf': ['mcp:tools', 'lm:write'],
